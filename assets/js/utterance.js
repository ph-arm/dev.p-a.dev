parcelRequire = function (e) {
    ...
    void 0 === c && (c = document.querySelector("script[src^=\"/assets/js/utterance.js\"],script[src^=\"http://localhost:4000/client.js\"]"));
    ...
    var y = c.src.match(/^https:\/\/utteranc\.es|http:\/\/127.0.0.1:\d+/)[0],
        z = y + "/utterances.html";
